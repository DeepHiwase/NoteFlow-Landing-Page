...
import ContextualRemainders from "../../assets/graphics/ContextualReminders.webp";

const Features = () => {
  return (
    <section className="bg-primary-1500 overflow-hidden bg-[url('../src/assets/Noise.webp')] bg-repeat">
      <div className="text-primary-50 relative m-auto max-w-[90rem] px-25 py-32">
        ...
        <h2 className="text-primary-50 mb-28 text-center text-6xl/18 font-semibold tracking-tighter drop-shadow-[0px_4xp_4px_rgba(0,0,0,0)_0.025]">
        ...
        <div className="mb-20 grid grid-cols-2 items-center gap-x-16">
          ...
          <div className="z-1 max-w-lg justify-self-end">
            <p className="mb-8 text-5xl/14 font-semibold tracking-tighter">
              Smart Organization
            </p>
        ...
        <div className="grid grid-cols-2 items-center gap-x-16">
          ...
          <figure className="z-1">
            <img
              src={ContextualRemainders}
              alt="Contextual remainders iphone graphic"
              className="max-h-[45rem]"
            />
          </figure>
        </div>
